%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%% LEACH Protocol Hyperound MATLAB Code %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
hypernd=1;          %Hyper Round of Opearion
hypernd_prev=0;     %Hyper Round of Previous Operation
...
for i=1:n
    ...
    hold on;
    figure(14)               %plotting 100 node random network
...
while operating_nodes>0          % Current Operating nodes
    rnd;                         % Current Round
    hypernd=ceil(rnd/5);        % Current Hyper Round as rounds fixed to 5
    if hypernd_prev<hypernd
   ...
   transmissions=transmissions-1;
    ...
    % This round Hyper round serves as next round's previous round
    hypernd_prev=hypernd; 
